...
def first_feature_engineering(train_old, test_old, train_list_i, test_list_i):
    ...
    test_old['month'] = test_old['时间'].apply(lambda x: get_month(x, test_list_i)).astype('int32')
    
    test_old['day'] = test_old['时间'].apply(lambda x: get_day(x, test_list_i)).astype('int32')
